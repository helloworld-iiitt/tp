            ...
            >
                ...
                <CardFooter className={`flex flex-col items-center justify-center  gap-2 text-[#808080] ${isHovered ? "text-white" : ""}`}>
                    <section className="flex justify-center items-center gap-1">
                        <a href={"https://www.linkedin.com/in/" + linkedinUrl} className="flex items-center gap-2" target="_blank">
                    ...
                    <section className="text-sm">
                        <a href={"tel:+91" + phone.split(',')[0]} className="flex items-center gap-1">
                            <Phone className="h-4" />
                            +91 {phone}
                        </a>
                        <a href={"mailto:" + email} className="flex justify-center items-center gap-1">
                            <Mail className="h-4" />
                            {email}
                        </a>
                    </section>
