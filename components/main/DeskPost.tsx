    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
            ...
            <div className="flip-card-front px-6 py-4">
                <h1 className='text-green-500 font-bold text-base sm:text-2xl text-center'>FROM THE DIRECTOR&apos;S DESK</h1>
                ...
                <section className=''>
                    <p className='text-base text-justify text-gray-600'>
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="sm:max-w-[800px] overflow-y-auto h-[80vh]-">
                                <DialogHeader>
