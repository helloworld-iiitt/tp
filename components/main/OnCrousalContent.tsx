...
export default function OnCrousalContent() {
    return (
        <div className='text-center'>
            <h1 className='text-2xl whitespace-nowrap md:text-6xl font-bold mb-3 text-green-500'>Training & Placement Cell</h1>
            <h1 className='text-lg md:text-5xl text-green-500'> IIIT Tiruchirappalli</h1>
