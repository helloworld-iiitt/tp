...
export default function OnCrousalContent() {
    return (
        <div className='text-center'>
            {/* <h1 className='text-3xl whitespace-nowrap md:text-6xl font-bold mb-3 text-green-500 shadow-blue-500/50'>Training & Placement Cell</h1>
            ...
            <section className='mt-5 flex flex-col md:flex-row justify-center gap-3' >
                ...
                <Link href='/docs/Placement Brochure IIIT Trichy 2024.pdf' target='_blank'>
                    <Button variant='outline' className='w-full'><FileText className='h-4' /> BROCHURE</Button>
                </Link>
